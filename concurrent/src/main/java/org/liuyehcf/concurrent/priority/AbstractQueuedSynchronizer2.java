...
public abstract class AbstractQueuedSynchronizer2
     ...
     * 直接获取资源时的钩子方法
     */
    protected abstract void onPassDirect();
     ...
     * AbstractQueuedSynchronizer2} serving as the basis of a {@link
    ...
    static {
        try {
            ...
            stateOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizer2.class.getDeclaredField("state"));
            headOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizer2.class.getDeclaredField("head"));
            tailOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizer2.class.getDeclaredField("tail"));
