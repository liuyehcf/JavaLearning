 ...
 * owner's tick() method.
 * <p>
 * A timer can be regex or irregular.  If in regex mode,
...
public class Timer {
     ...
     * object is stopped and is regex.  getRemainingTime()
    ...
    /**
     * In regex mode, a timer ticks at the specified interval,
