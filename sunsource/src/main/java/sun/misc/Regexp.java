...
/**
 * A class to represent a regex expression.  Only handles '*'s.
 *
...
public class Regexp {
    ...
    /*
     * regex expressions are carved into three regions: a constant string
     * prefix, a constant string suffix, and a series of floating strings in
     * between.  In the input regex expression, they are separated by *s
     */
    public String exp;
    ...
    /**
     * Create a new regex expression object.  The regex expression
    ...
    /**
     * Returns true iff the String s matches this regex expression.
     */
